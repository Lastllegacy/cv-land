      ...
      <div className={list}>
        <ol>
          <li>
            ...
            <p>
              In this project i learnt how to work with external api using fetch
              and load content using react and react-hooks.
            </p>
            <p className={tags}>
          ...
          <li>
            ...
            <p>
              By doing this page sign-up, i learnt how to work with form and
              validation, also how to make adaptive and responsive design
            </p>
            <p className={tags}>HTML, CSS, Javascript, Json Api, async</p>
          </li>
          <li>
            <p>
              "Superfood-helper":{" "}
            ...
            <p>
              This is the project that i'm currently working on, im learning
              here deeper react. It's not done yet (but you can view the source
              code)
            </p>
            <p className={tags}>
